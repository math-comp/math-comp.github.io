...
- Mohit Tekriwal, Avi Tachna-Fram, Jean-Baptiste Jeannin, Manos Kapritsos, Dimitra Panagou.
  _Formally verified asymptotic consensus in robust networks_. 30th International Conference on Tools and Algorithms for the Construction and Analysis of Systems (TACAS 2024). [[https://arxiv.org/pdf/2202.13833.pdf][pdf]]
...
- Cyril Cohen, Kazuhiko Sakaguchi, Enrico Tassi.
  ...
  5th International Conference on Formal Structures for Computation and Deduction (FSCD 2020). [[https://hal.inria.fr/hal-02478907v4/document][pdf]]
- Karl Palmskog, Ahmet Celik, Milos Gligoric.
  _Practical Machine-Checked Formalization of Change Impact Analysis_.
  26th International Conference on Tools and Algorithms for the Construction and Analysis of Systems (TACAS 2020). [[https://users.ece.utexas.edu/~gligoric/papers/PalmskogETAL20Chip.pdf][pdf]]
