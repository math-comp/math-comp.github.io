...
- It is possible to install the Mathematical Components libraries on
  ...
  or together with [[https://fdopen.github.io/opam-repository-mingw/installation/][opam for Windows]], as explained [[https://github.com/affeldt-aist/mathcomp-install/blob/master/install-windows-en.org][here]]
